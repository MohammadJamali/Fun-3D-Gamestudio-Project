...
ENGINE_BMAP		video_overlay;		// engine window overlay
ENGINE_BMAP		render_lightmap;	// lightmap of the current object
ENGINE_ long	epunused2[1];
ENGINE_CONTACT  hit;
...
// DirectX interfaces ////////////////////////////////////////////////
// The DirectX version used for A7 is DirectX 9.0c of April 2006.
// Use the same version when calling DirectX function with the pointers below.
...
ENGINE_ void** pbody;		// info about the current model
ENGINE_ void* pvertexdecl;	// vertex declaration
...
ENGINE_ HWND  hWndParent;	// parent window
ENGINE_ void* dunused2[3];	// not used
